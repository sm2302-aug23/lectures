...
% Load theme -------------------------------------------------------------------
% ------------------------------------------------------------------------------
\usetheme[$if(progressdots)$progressdots,$endif$$if(transitions)$transitions$endif$]{ubd}
...
% Bibliography -----------------------------------------------------------------
$if(bibliography)$
\usepackage[$if(bibstyle)$style=$bibstyle$$endif$,maxcitenames=2,maxbibnames=99,backend=biber,natbib]{biblatex}
...
$if(toc)$
\begin{frame}[plain,noframenumbering]{$toctitle$}
  $if(tocmulticol)$
  \begin{multicols}{$tocmulticol$}
  \tableofcontents
  \end{multicols}
  $else$
  \tableofcontents
