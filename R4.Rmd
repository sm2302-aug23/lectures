...
::: {.column width=49%}
```{r ref.label = "penguins-3", echo = FALSE, warning = FALSE}
```
:::
...
::: {.column width=49%}
```{r ref.label = "penguins-4", echo = FALSE, warning = FALSE}
```
:::
...
::: {.column width=49%}
```{r ref.label = "penguins-5", echo = FALSE, warning = FALSE, fig.height = 4.8}
```
:::
...
::: {.column width=49%}
```{r ref.label = "penguins-7", echo = FALSE, warning = FALSE, fig.height = 4.8}
```
:::
...
::: {.column width=49%}
```{r ref.label = "penguins-8", echo = FALSE, warning = FALSE, fig.height = 4.8}
```
:::
...
::: {.column width=49%}
```{r ref.label = "penguins-9", echo = FALSE, warning = FALSE, fig.height = 4.8}
```
:::
...
::: {.column width=49%}
```{r ref.label = "colour", echo = FALSE, warning = FALSE, fig.height = 4.8}
```
:::
...
::: {.column width=49%}
```{r ref.label = "shapeisland", echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "shapespecies", echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "size1", echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "size2", echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "alpha", echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r, warning = FALSE, echo = FALSE, fig.height = 4.2}
ggplot(
  penguins, 
  aes(
    x = bill_depth_mm, 
...
```{r boxplot1, warning = FALSE, fig.height = 4.1}
...
::: {.column width=49%}
```{r boxplot2, warning = FALSE, fig.height = 4.1}
ggplot(penguins, aes(x = body_mass_g,
                     y = species)) +
  geom_boxplot()
```
...
```{r barplot1, warning = FALSE, fig.height = 4.1}
ggplot(penguins, aes(x = species)) +
  geom_bar()
...
::: {.column width=49%}
```{r barplot2, warning = FALSE, fig.height = 4.1}
ggplot(penguins, aes(x = species,
                     fill = island)) +
  geom_bar()
```
...
```{r barplot3, warning = FALSE, fig.height = 4.1}
ggplot(penguins, aes(x = species,
                     fill = island)) +
...
::: {.column width=49%}
```{r barplot4, warning = FALSE, fig.height = 4.1}
ggplot(penguins, aes(x = species,
                     fill = sex)) +
...
```{r scatter1, warning = FALSE, message = FALSE, fig.height = 3.8}
ggplot(penguins, aes(x = bill_depth_mm,
                     y = bill_length_mm)) +
  geom_point() +
  geom_smooth()
...
::: {.column width=49%}
```{r scatter2, warning = FALSE, message = FALSE, fig.height = 3.6}
ggplot(penguins, aes(x = bill_depth_mm,
                     y = bill_length_mm,
                     col = species)) +
  geom_point() +
...
::: {.column width=49%}
```{r  message = FALSE, echo = FALSE, warning = FALSE, fig.height = 4.5}
p
```
:::
...
::: {.column width=49%}
```{r ref.label = "manualcol", message = FALSE, echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "viridiscol", message = FALSE, echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
...
::: {.column width=49%}
```{r ref.label = "viridiscol2", message = FALSE, echo = FALSE, warning = FALSE, fig.height = 4.5}
```
:::
